...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "demo Support <support@demo-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_1 API",
    "DESCRIPTION": "API documentation for demo_1 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "demo_1.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "demo_1.storage_backends.AzureStaticStorage"
